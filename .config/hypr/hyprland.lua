...
local main_mod = 'ALT' -- Sets 'Windows' key as main modifier
...
-- Hyprlock
hl.bind(main_mod .. ' + CONTROL + L', hl.dsp.exec_cmd('pactl set-sink-mute @DEFAULT_SINK@ 1 && hyprlock'))
...
-- Calculator
hl.bind('XF86Calculator', hl.dsp.exec_cmd('rofi -show calc'))


-- Current time
hl.bind(main_mod .. ' + CONTROL + T', hl.dsp.exec_cmd('~/.config/hypr/scripts/time'))


-- Current battery
hl.bind(main_mod .. ' + CONTROL + B', hl.dsp.exec_cmd('~/.config/hypr/scripts/battery'))


-- Notifications
hl.bind(main_mod .. ' + CONTROL + N', hl.dsp.exec_cmd('swaync-client -t -sw'))
